...
test('Should not insert if name is empty', () => request(server).post(MAIN_ROUTE)
...
test('Should not insert if name is null/undefined', () => request(server).post(MAIN_ROUTE)
...
test('Should not insert if user_id is null/undefined', () => request(server).post(MAIN_ROUTE)
